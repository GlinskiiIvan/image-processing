...
cv2.imwrite('./medianBlur_sobel/denoised_image.png', denoised_img)
cv2.imwrite('./medianBlur_sobel/equalized_image_clahe.png', equalized_img)
cv2.imwrite('./medianBlur_sobel/edges_image.png', edges)
