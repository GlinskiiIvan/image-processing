...
cv2.imwrite('./bilateralFilter_laplacian/denoised_image.png', denoised_img)
cv2.imwrite('./bilateralFilter_laplacian/equalized_image_clahe.png', equalized_img)
cv2.imwrite('./bilateralFilter_laplacian/laplacian_edges_image.png', laplacian_abs)
